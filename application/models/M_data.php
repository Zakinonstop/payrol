...
class M_data extends CI_Model
{
    ...
    function pegawai_by_tahun($tahun, $bulan)
    {
        $this->db->select('*');
        $this->db->from('user');
        $this->db->join('pegawai', 'user.nip = pegawai.nip');
    ...
    function absenbulan($id, $tahun, $bulan)
    {
        ...
        $this->db->like('waktu', $tahun);
        $this->db->like('waktu', $bulan);
        return $this->db->get();
    }
    ...
    public function addTahun($tahunBaru)
    {
        // cek data tahun terakhir 
