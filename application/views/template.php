...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand  navbar-light" style="background-color: #59724B">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #59724B">
            <!-- Brand Logo -->
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        ...
                        <a href="#" class="d-block"><small>User login :</small><br> <b><?= $this->session->userdata('nama') ?> <?= $levell; ?></b></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if ($this->session->userdata('level') == 'admin') { ?>
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url($this->session->userdata('level')) ?>/laporan" class="nav-link">
        ...
        <!-- /.content-wrapper -->
        <footer class="main-footer" style="background-color: #8CBA60; color: white">
            <strong>Copyright &copy;<?= date('Y') ?> <a href="#" style="color: white"><?= $web->nama ?></a>.</strong>
            D3 Akuntansi - Universitas Muhammadiyah Yogyakarta.
